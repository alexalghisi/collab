...
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| Android               | [`app-release.apk`](https://github.com/alexalghisi/collab/releases/download/v1.3.1/app-release.apk)                               | Copy to an Android device and open it. Allow "install from unknown sources" when prompted. |
| iOS                   | [`Collab-unsigned.ipa`](https://github.com/alexalghisi/collab/releases/download/v1.3.1/Collab-unsigned.ipa)                       | Unsigned build — install by sideloading (AltStore / Sideloadly) or use TestFlight (below). |
| Windows               | [`Collab.Setup.1.3.1.exe`](https://github.com/alexalghisi/collab/releases/download/v1.3.1/Collab.Setup.1.3.1.exe)                 | Run the installer and launch **Collab** from the Start menu.                               |
| macOS (Apple Silicon) | [`Collab-1.3.1-arm64.dmg`](https://github.com/alexalghisi/collab/releases/download/v1.3.1/Collab-1.3.1-arm64.dmg)                 | Open the `.dmg`, drag **Collab** into Applications, then launch it.                        |
| macOS (Intel)         | [`Collab-1.3.1-x64.dmg`](https://github.com/alexalghisi/collab/releases/download/v1.3.1/Collab-1.3.1-x64.dmg)                     | Open the `.dmg`, drag **Collab** into Applications, then launch it.                        |
| Linux (AppImage)      | [`Collab-1.3.1.AppImage`](https://github.com/alexalghisi/collab/releases/download/v1.3.1/Collab-1.3.1.AppImage)                   | `chmod +x` the file, then run it. Works on most distributions.                             |
| Linux (Debian/Ubuntu) | [`collab-desktop_1.3.1_amd64.deb`](https://github.com/alexalghisi/collab/releases/download/v1.3.1/collab-desktop_1.3.1_amd64.deb) | Install with `sudo dpkg -i collab-desktop_1.3.1_amd64.deb`, then launch **Collab**.        |
