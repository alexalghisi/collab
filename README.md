...
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| Android               | [`app-release.apk`](https://github.com/alexalghisi/collab/releases/download/v1.3.2/app-release.apk)                               | Copy to an Android device and open it. Allow "install from unknown sources" when prompted. |
| iOS                   | [`Collab-unsigned.ipa`](https://github.com/alexalghisi/collab/releases/download/v1.3.2/Collab-unsigned.ipa)                       | Unsigned build — install by sideloading (AltStore / Sideloadly) or use TestFlight (below). |
| Windows               | [`Collab.Setup.1.3.2.exe`](https://github.com/alexalghisi/collab/releases/download/v1.3.2/Collab.Setup.1.3.2.exe)                 | Run the installer and launch **Collab** from the Start menu.                               |
| macOS (Apple Silicon) | [`Collab-1.3.2-arm64.dmg`](https://github.com/alexalghisi/collab/releases/download/v1.3.2/Collab-1.3.2-arm64.dmg)                 | Open the `.dmg`, drag **Collab** into Applications, then launch it.                        |
| macOS (Intel)         | [`Collab-1.3.2-x64.dmg`](https://github.com/alexalghisi/collab/releases/download/v1.3.2/Collab-1.3.2-x64.dmg)                     | Open the `.dmg`, drag **Collab** into Applications, then launch it.                        |
